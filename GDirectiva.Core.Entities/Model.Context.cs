...
public partial class DB_INNOVASCHOOLSEntities : DbContext
{
    ...
    public virtual int PA_ACTIVIDAD_PLAN_ASIGNATURA_REGISTRAR(string aCTIVIDAD, Nullable<System.DateTime> fECHAINICIO, Nullable<System.DateTime> fECHAFIN, Nullable<int> pORCENTAJEAVANCE, Nullable<int> iD_PLANASIGNATURA, Nullable<int> iD_EMPLEADO)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_ACTIVIDAD_PLAN_ASIGNATURA_REGISTRAR", aCTIVIDADParameter, fECHAINICIOParameter, fECHAFINParameter, pORCENTAJEAVANCEParameter, iD_PLANASIGNATURAParameter, iD_EMPLEADOParameter);
    }
